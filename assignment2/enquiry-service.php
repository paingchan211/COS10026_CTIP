...
<html>
  <head>
    ...
    <meta
      name="author"
      content="Daniel Sie, Zwe Htet Zaw, Paing Chan, Sherlyn Kok, Michael Wong"
    />
      ...
      >
        ...
        <fieldset>
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                <select id="service" name="service" >
                  ...
                  <option value="haircut_trimming">Haircut and Trimming</option>
                  <option value="sewing_alteration">
            ...
            <tr>
              <td colspan="2">
                <p id="contact-method_text">
                  Please check your preferred contact-methods:
                </p>
        ...
        <fieldset>
          ...
          <table>
            <tr>
              <td><label for="online">Online:</label><br /></td>
              <td>
                <input
                  type="radio"
                  id="online"
            ...
            <tr>
              <td><label for="onsite">Onsite:</label><br /></td>
              <td>
                <input
                  type="radio"
                  id="onsite"
